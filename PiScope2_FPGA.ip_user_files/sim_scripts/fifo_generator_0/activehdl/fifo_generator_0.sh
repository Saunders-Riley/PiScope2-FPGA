...
#
# Script generated by Vivado on Mon Oct 16 21:00:33 -0400 2023
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Riley/PiScope2/FPGA/PiScope2_FPGA/PiScope2_FPGA.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
